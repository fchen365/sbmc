...
VEM_SBM.R  	--	Variational EM regarding or disregarding covariates
casc.R  	--	Covariate Assisted Spectral Clustering

Simulation related work
job.R   	--	Work required by Hoffman2
gen_demo.R	--	Generating a random positive-definite matrix with user-specified positive eigenvalues
